...
class azTaskbarBaseButton extends St.Button {
    _init(settings) {
        ...
        this._settings.connectObject('changed::icon-size', () => this.updateIcon(), this);
...
export const AppIcon = GObject.registerClass({
    ...
    _init(appDisplayBox, app, monitorIndex, isFavorite) {
        ...
        this._settings.connectObject('changed::multi-window-indicator-style', () => this._onIndicatorSettingChanged(), this);
        this._settings.connectObject('changed::indicator-location', () => this._onIndicatorSettingChanged(), this);
        this._settings.connectObject('changed::indicator-color-running', () => this._onIndicatorSettingChanged(), this);
        this._settings.connectObject('changed::indicator-color-focused', () => this._onIndicatorSettingChanged(), this);
        this._settings.connectObject('changed::desaturation-factor', () => this._setDesaturateEffect(), this);
        this._settings.connectObject('changed::icon-style', () => this.updateIcon(), this);
